...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * Migration from v1 to v2: adds indexes on feed_items(isRead), feed_items(publishedAt),
         * and feed_items(sourceId) to speed up the filtered, sorted queries in FeedItemDao.
         *
